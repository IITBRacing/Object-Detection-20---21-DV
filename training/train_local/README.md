...
## Training :
  ...
  4. **DONOT forget to create a backup folder in the root directory** that is in the darknet folder. This is the location where the trained weights file is generated adn gets updated iteratively  
